ppc.step1 <- function(y.o, model,
                      ...
                      nchains=2, nburnin=5000, nsample=5000, dp=NULL,convergence="manual",
                      missingdata.o = FALSE, imp,
                      n.r,nsim=5000,
                      post, pT, free.i){
  ...
  ps1 <- posterior.step1(y.o=y.o, model=model,
                         ...
                         nchains=nchains, nburnin=nburnin, nsample=nsample, dp=dp,
                         missingdata.o = missingdata.o, imp=imp,convergence=convergence)
